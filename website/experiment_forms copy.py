...
@expt_views.route("/setup_experiment")
def setup_experiment():
    return render_template("setup_experiment.html")

@expt_views.route("/setup_experiment_mo")
def setup_experiment_mo():
    return render_template("setup_experiment_mo.html")
